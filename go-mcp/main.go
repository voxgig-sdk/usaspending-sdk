// Command Usaspending-mcp is an MCP server exposing the Usaspending
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Usaspending_list  — list records of an entity
//	Usaspending_load  — load a single record of an entity
//
