...
type Args struct {
	Entity string         `json:"entity" jsonschema:"account | agency | award | search | spending"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UsaspendingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "usaspending_list",
		Description: "List records from Usaspending. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "usaspending_load",
		Description: "Load a single record from Usaspending. " +
...
func runOp(client *sdk.UsaspendingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UsaspendingSDK, name string) (sdk.UsaspendingEntity, error) {
	...
	case "award":
		return client.Award(nil), nil
	case "search":
		return client.Search(nil), nil
	case "spending":
		return client.Spending(nil), nil
