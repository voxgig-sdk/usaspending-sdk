...
// Usaspending SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UsaspendingTransformResponse
{
    public static function call(UsaspendingContext $ctx): mixed
    {
        ...
        $transform = UsaspendingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
