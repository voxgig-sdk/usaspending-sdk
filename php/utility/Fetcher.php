...
// Usaspending SDK utility: fetcher
...
class UsaspendingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UsaspendingSDK/1.0)';
    ...
    public static function call(UsaspendingContext $ctx, string $fullurl, array $fetchdef): array
    {
