...
// Usaspending SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UsaspendingMakeRequest
{
    public static function call(UsaspendingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UsaspendingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UsaspendingResponse($fetched);
        } else {
