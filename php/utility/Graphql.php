...
// Usaspending SDK utility: graphql
//
...
class UsaspendingGraphql
{
    ...
    // equivalent.
    public static function body(UsaspendingContext $ctx): mixed
    {
    ...
    public static function errors(UsaspendingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
