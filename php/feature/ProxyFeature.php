...
class UsaspendingProxyFeature extends UsaspendingBaseFeature
{
    ...
    public function init(UsaspendingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UsaspendingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
