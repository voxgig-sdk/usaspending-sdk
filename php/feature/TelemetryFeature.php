...
// Usaspending SDK telemetry feature
...
class UsaspendingTelemetryFeature extends UsaspendingBaseFeature
{
    ...
    private function _close(UsaspendingContext $ctx, bool $ok): void
    {
