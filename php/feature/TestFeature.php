...
// Usaspending SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UsaspendingTestFeature extends UsaspendingBaseFeature
{
    ...
    public function init(UsaspendingContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UsaspendingContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UsaspendingParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UsaspendingContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UsaspendingContext $ctx, $op, $args): array
    {
