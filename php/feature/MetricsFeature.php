...
// Usaspending SDK metrics feature
...
class UsaspendingMetricsFeature extends UsaspendingBaseFeature
{
    ...
    private function _record(UsaspendingContext $ctx, bool $ok): void
    {
