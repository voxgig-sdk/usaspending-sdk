...
// Usaspending SDK streaming feature
...
class UsaspendingStreamingFeature extends UsaspendingBaseFeature
{
    ...
    private function _iterate(UsaspendingResult $result): \Generator
    {
    ...
    private function _streamable(UsaspendingContext $ctx): bool
    {
