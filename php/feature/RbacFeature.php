...
class UsaspendingRbacFeature extends UsaspendingBaseFeature
{
    ...
    private function _required(UsaspendingContext $ctx): ?string
    {
    ...
    private function _reject(UsaspendingContext $ctx, string $required): void
    {
    ...
    private function _track(UsaspendingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
