...
class AwardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AwardEntity($this->_client, $opts);
    }

    /**
     * @param Award|array $args Award data (assoc-array) to store.
     */
    ...
    /**
     * @return Award|array The current Award data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Award fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Award fields).
     */
     ...
     *
     * @param AwardListMatch|array|null $reqmatch Match filter (any subset
     *   of Award fields) as an assoc-array; AwardListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Award[]|array A list of Award items as assoc-arrays at
