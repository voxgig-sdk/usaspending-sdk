...
class AwardDirectTest extends TestCase
{
    public function test_direct_list_award(): void
    {
        $setup = award_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-award", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
