...
class UsaspendingTestRunner
{
    ...
    {
        $live = self::getenv('USASPENDING_TEST_LIVE');
        $override = self::getenv('USASPENDING_TEST_OVERRIDE');
        ...
        $explain = self::getenv('USASPENDING_TEST_EXPLAIN');
...
class_alias('UsaspendingTestRunner', 'Runner');
class_alias('UsaspendingHelpers', 'Helpers');
