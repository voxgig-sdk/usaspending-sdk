...
class SpendingDirectTest extends TestCase
{
    public function test_direct_list_spending(): void
    {
        $setup = spending_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-spending", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
