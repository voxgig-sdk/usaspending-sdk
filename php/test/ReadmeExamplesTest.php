...
// Usaspending SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UsaspendingSDK::test)
...
{
    private const SDK_CLASS = 'UsaspendingSDK';
    ...
    private const SDK_BASE = 'usaspending_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../usaspending_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
