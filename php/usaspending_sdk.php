...
class UsaspendingSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UsaspendingHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UsaspendingHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UsaspendingFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UsaspendingFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UsaspendingUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UsaspendingHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UsaspendingHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UsaspendingHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UsaspendingError($op . "_allow",
                "UsaspendingSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UsaspendingHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UsaspendingError("graphql_error",
                "UsaspendingSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Award($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_award === null) {
                $this->_award = new AwardEntity($this, null);
            }
            return $this->_award;
        }
        return new AwardEntity($this, $data);
    }
    ...
    public function Spending($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_spending === null) {
                $this->_spending = new SpendingEntity($this, null);
            }
            return $this->_spending;
        }
        return new SpendingEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UsaspendingSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
