...
function envOverride(m) {
    if ('TRUE' === process.env.USASPENDING_TEST_LIVE ||
        'TRUE' === process.env.USASPENDING_TEST_OVERRIDE) {
    ...
    m.USASPENDING_TEST_EXPLAIN = process.env.USASPENDING_TEST_EXPLAIN || m.USASPENDING_TEST_EXPLAIN;
    return m;
}
