...
(0, node_test_1.describe)('AwardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-award', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-award', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['USASPENDING_TEST_AWARD_ENTID'];
...
//# sourceMappingURL=AwardDirect.test.js.map