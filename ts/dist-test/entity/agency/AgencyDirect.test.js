...
(0, node_test_1.describe)('AgencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UsaspendingSDK({
    ...
    (0, node_test_1.test)('direct-list-agency', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-agency', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.USASPENDING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'USASPENDING_TEST_AGENCY_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.UsaspendingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['USASPENDING_TEST_AGENCY_ENTID'];
    ...
    const client = new __1.UsaspendingSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AgencyDirect.test.js.map