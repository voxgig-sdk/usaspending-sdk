...
(0, node_test_1.describe)('SearchEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('USASPENDING_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.UsaspendingSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.UsaspendingSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.UsaspendingSDK(merge([
