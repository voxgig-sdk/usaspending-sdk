...
exports.UsaspendingEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends UsaspendingEntityBase<Advice>`.
class UsaspendingEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.UsaspendingEntityBase = UsaspendingEntityBase;
//# sourceMappingURL=UsaspendingEntityBase.js.map