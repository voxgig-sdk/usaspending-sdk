...
class UsaspendingSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('UsaspendingSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Award(entopts?: Record<string, any>) {
    const self = this
    return new AwardEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Spending(entopts?: Record<string, any>) {
    const self = this
    return new SpendingEntity(self, entopts)
  }
