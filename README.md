...
The USAspending API provides public access to comprehensive U.S.

Learn more about USAspending API at [usaspending.gov](https://usaspending.gov).
...
This SDK exposes the API as a small set of **semantic entities** — Account, Agency, Award, Search and Spending — that you
