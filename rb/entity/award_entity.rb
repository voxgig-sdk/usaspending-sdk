...
class AwardEntity
  ...
  #
  # @param reqmatch [AwardListMatch, Hash, nil] match filter (any subset of
  #   Award fields); defaults to nil, treated as an empty match that lists all.
