...
class AccountEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set USASPENDING_TEST_ACCOUNT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def account_basic_setup(extra)
  ...
  entid_env_raw = ENV["USASPENDING_TEST_ACCOUNT_ENTID"]
