...
#      offline in seeded test mode (UsaspendingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Usaspending_sdk.rb")
  SDK_CLASS = "UsaspendingSDK"
