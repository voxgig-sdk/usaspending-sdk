...
The Ruby SDK for the Usaspending API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `UsaspendingError` (a `StandardError` subclass), so wrap
