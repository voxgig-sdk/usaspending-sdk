...
func NewAwardEntity(client *core.UsaspendingSDK, entopts map[string]any) *AwardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AwardEntity) GetName() string { return e.name }
...
func (e *AwardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AwardEntity) Deleted() bool {
	return e.deleted
}


func (e *AwardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAwardEntity(e.client, opts)
}

func (e *AwardEntity) Data(args ...any) any {
...
func (e *AwardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AwardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AwardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AwardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AwardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AwardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AwardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
