...
type SpendingEntity struct {
	name    string
	client  *core.UsaspendingSDK
...
func NewSpendingEntity(client *core.UsaspendingSDK, entopts map[string]any) *SpendingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SpendingEntity) GetName() string { return e.name }
...
func (e *SpendingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SpendingEntity) Deleted() bool {
	return e.deleted
}


func (e *SpendingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSpendingEntity(e.client, opts)
}

func (e *SpendingEntity) Data(args ...any) any {
...
func (e *SpendingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Spending; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SpendingEntity) DataTyped(data ...Spending) Spending {
	if len(data) > 0 {
		return typedFrom[Spending](e.Data(asMap(data[0])))
	}
	return typedFrom[Spending](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Spending (all fields
// optional at the wire level).
func (e *SpendingEntity) MatchTyped(match ...Spending) Spending {
	if len(match) > 0 {
		return typedFrom[Spending](e.Match(asMap(match[0])))
	}
	return typedFrom[Spending](e.Match())
}
...
func (e *SpendingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SpendingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SpendingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SpendingListMatch and returns []Spending. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SpendingEntity) ListTyped(reqmatch SpendingListMatch, ctrl map[string]any) ([]Spending, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Spending](res), nil
}



func (e *SpendingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SpendingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SpendingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SpendingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
