...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "award": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "spending": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
