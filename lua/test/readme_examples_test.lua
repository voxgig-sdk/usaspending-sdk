...
local SDK_MODULE = "usaspending_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["account"] = { ["test01"] = { id = "test01" } }, ["agency"] = { ["test01"] = { id = "test01" } }, ["award"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["spending"] = { ["test01"] = { id = "test01" } } } }'
