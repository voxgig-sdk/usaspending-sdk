...
function runner.env_override(m)
  local live = runner.getenv("USASPENDING_TEST_LIVE")
  local override = runner.getenv("USASPENDING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("USASPENDING_TEST_EXPLAIN")
