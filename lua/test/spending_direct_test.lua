...
describe("SpendingDirect", function()
  it("should direct-list-spending", function()
    local setup = spending_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-spending", setup.live and "live" or "unit")
...
function spending_direct_setup(mockres)
