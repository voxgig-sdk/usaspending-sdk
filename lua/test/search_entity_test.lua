...
describe("SearchEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set USASPENDING_TEST_SEARCH_ENTID JSON to run live")
      return
    end
    ...
    local search_ref01_data = helpers.to_map(vs.getprop(
...
function search_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("USASPENDING_TEST_SEARCH_ENTID")
