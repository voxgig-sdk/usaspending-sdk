...
describe("AwardDirect", function()
  it("should direct-list-award", function()
    local setup = award_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-award", setup.live and "live" or "unit")
...
function award_direct_setup(mockres)
