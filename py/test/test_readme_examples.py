# Usaspending SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UsaspendingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UsaspendingSDK(...) and UsaspendingSDK.test(...) become
#      UsaspendingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "usaspending_sdk"
_SDK_CLASS = "UsaspendingSDK"
