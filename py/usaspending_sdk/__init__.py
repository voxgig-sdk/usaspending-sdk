...
from usaspending_sdk.utility import register

# Load features
from usaspending_sdk.feature.base_feature import UsaspendingBaseFeature
from usaspending_sdk.features import _has_feature, _make_feature
...
class UsaspendingSDK:
    ...
    def get_utility(self):
        return UsaspendingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UsaspendingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Account(self, data=None) -> "AccountEntity":
        ...
        from usaspending_sdk.entity.account_entity import AccountEntity
