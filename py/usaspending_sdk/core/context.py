...
from usaspending_sdk.core.control import UsaspendingControl
...
from usaspending_sdk.core.helpers import get_ctx_prop, to_map
...
class UsaspendingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UsaspendingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UsaspendingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UsaspendingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UsaspendingError(code, msg, self)
