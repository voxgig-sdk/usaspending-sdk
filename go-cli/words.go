...
func registerSDKWords(r *eng.Registry, client *sdk.UsaspendingSDK) {
...
func runOp(client *sdk.UsaspendingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
