...
// Usaspending SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UsaspendingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UsaspendingOmni::structfix($now, Struct::undef()))
                        !== json_encode(UsaspendingOmni::structfix($val, Struct::undef()))) {
