...
// Usaspending SDK clienttrack feature
...
class UsaspendingClienttrackFeature extends UsaspendingBaseFeature
{
    ...
    public function PostConstruct(UsaspendingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Usaspending-SDK';
