...
// Usaspending SDK netsim feature
...
class UsaspendingNetsimFeature extends UsaspendingBaseFeature
{
    ...
    private function _simulate(UsaspendingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UsaspendingContext $ctx, array $applied): void
    {
        $client = $this->client;
