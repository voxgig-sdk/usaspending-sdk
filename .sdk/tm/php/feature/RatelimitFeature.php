...
// Usaspending SDK ratelimit feature
...
class UsaspendingRatelimitFeature extends UsaspendingBaseFeature
{
    ...
    private function _acquire(UsaspendingContext $ctx): void
    {
    ...
    private function _track(UsaspendingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
