...
// Usaspending SDK timeout feature
...
class UsaspendingTimeoutFeature extends UsaspendingBaseFeature
{
    ...
    private function _with_timeout(UsaspendingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UsaspendingContext $_ctx, float $ms): void
    {
        $client = $this->client;
