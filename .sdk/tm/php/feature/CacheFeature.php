...
class UsaspendingCacheFeature extends UsaspendingBaseFeature
{
    ...
    private function _through(UsaspendingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
