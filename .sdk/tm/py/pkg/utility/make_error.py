...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import UsaspendingContext
        ctx = UsaspendingContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, UsaspendingError):
        errmsg = err.msg
    ...
    sdk_err = UsaspendingError("", msg, ctx)
