...
class UsaspendingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UsaspendingTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UsaspendingTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UsaspendingTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
