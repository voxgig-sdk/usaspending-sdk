...
class UsaspendingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UsaspendingTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UsaspendingTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UsaspendingTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
