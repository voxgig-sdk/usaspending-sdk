...
|---|---|---|
| `ts/` | @voxgig-sdk/usaspending-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/usaspending-sdk \
      --repository voxgig-sdk/usaspending-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/usaspending-sdk` shows it, and
`npm trust revoke @voxgig-sdk/usaspending-sdk --id=<id>` removes it.
